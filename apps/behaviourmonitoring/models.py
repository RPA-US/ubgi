...
class Monitoring(models.Model):
    ...
    title = models.CharField(max_length=100, default="New UB Gaze Enricher Configuration")
    ...
    ui_log_filename = models.CharField(max_length=100, default='Recording_20240704_1631.mht')
